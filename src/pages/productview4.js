...
import img1 from '../images/product4/161.jpg'
import img2 from '../images/product4/166.jpg'
import img3 from '../images/product4/174.jpg'
import img4 from '../images/product4/178.jpg'
import img5 from '../images/product4/181.jpg'
import img6 from '../images/product4/188.jpg'
...
const ProductView4 = () => {
  ...
  const gontChange = e => {
    setGont(e);
    gont !== "true" ? setPrice(price + 1100) : setPrice(price - 1100);
  }
  ...
  <Layout>
    ...
    <div className="productViewPlate">
      ...
      <div className="productDescription">
          ...
          <div id="productTitle">Domek Letniskowy 5mx3m</div>
          ...
          <h3>Dodatkowe opcje:</h3>
              ...
              <div className="productDescriptionText"
                  ...
                  <h3>Opis</h3>
                  <p>
                  Drewniany domek letniskowy o powierzchni całkowitej 15m<sup>2</sup> z powierzchnią domku 9m<sup>2</sup> oraz tarasem o powierzchni 6m<sup>2</sup>, stanowi zarówno elegancką ozdobę ogrodu jak i doskonałe miejsce do wypoczynku. Taras stanowi doskonałą lokalizację dla mebli ogrodowych. Domek letniskowy drewhaus to gwarancja solidności i jakości na długie lata!<br/>
                  </p>
                  <h3>Dane techniczne:</h3>
                  <ul>
                    <li>Materiał: suszone drewno świerkowe</li>
                    <li>Wymiar zewnętrzny całkowity: 500cm x 300cm </li>
                    <li>Wymiar zewnętrzny ścian: 481cm x 281cm</li>
                    <li>Wymiar wewnętrzny ścian: 275 cm x 275 cm</li>
                    <li>Wysokość ściany: 195 cm</li>
                    <li>Wysokość do szczytu:235 cm</li>
                    <li>Powierzchnia dachu: 17,60m<sup>2</sup></li>
                    <li>Grubość ścian: aż 34 mm</li>
                    <li>Grubość deski dachowej: 18mm</li>
                    <li>Grubość deski podłogowej: 19mm</li>
                    <li>Okno: oszklone 60cm x 80cm</li>
