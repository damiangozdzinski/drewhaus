...
import img1 from '../images/product5/205.jpg'
import img2 from '../images/product5/214.jpg'
import img3 from '../images/product5/224.jpg'
import img4 from '../images/product5/226.jpg'
import img5 from '../images/product5/251.jpg'
import img6 from '../images/product5/258.jpg'
...
const ProductView5 = () => {
  ...
  const montageChange = e => {
    setMontage(e);
    montage !== "true" ? setPrice(price + 2100) : setPrice(price - 2100);
  }

  const gontChange = e => {
    setGont(e);
    gont !== "true" ? setPrice(price + 1200) : setPrice(price - 1200);
  }
  ...
  <Layout>
    ...
    <div className="productViewPlate">
      ...
      <div className="productDescription">
          ...
          <div id="productTitle">Domek Letniskowy 5mx4m</div>
          ...
          <h3>Dodatkowe opcje:</h3>
            <h4>Montaż:</h4>
              ...
              <div className="productDescriptionText"
                  ...
                  <h3>Opis</h3>
                  <p>
                    Drewniany domek letniskowy o powierzchni całkowitej 20m<sup>2</sup> z powierzchnią domku 12m<sup>2</sup> oraz tarasem o powierzchni 8m<sup>2</sup>, stanowi zarówno elegancką ozdobę ogrodu jak i doskonałe miejsce do wypoczynku. Taras stanowi doskonałą lokalizację dla mebli ogrodowych. Domek letniskowy drewhaus to gwarancja solidności i jakości na długie lata!<br/>
                  </p>
                  <h3>Dane techniczne:</h3>
                  <ul>
                    <li>Materiał: suszone drewno świerkowe</li>
                    <li>Wymiar zewnętrzny całkowity: 500cm x 400cm </li>
                    <li>Wymiar zewnętrzny ścian: 481cm x 381cm</li>
                    <li>Wymiar wewnętrzny ścian: 375 cm x 275 cm</li>
                    <li>Wysokość ściany: 195 cm</li>
                    <li>Wysokość do szczytu:235cm</li>
                    <li>Powierzchnia dachu: 22,90m<sup>2</sup></li>
