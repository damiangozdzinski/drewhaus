...
const ProductView3 = () => {
  ...
  const [price, setPrice] = useState(5950);
  ...
  const montageChange = e => {
    setMontage(e);
    montage !== "true" ? setPrice(price + 1200) : setPrice(price - 1200);
  }

  const gontChange = e => {
    setGont(e);
    gont !== "true" ? setPrice(price + 900) : setPrice(price - 900);
  }
  ...
  const floorChange = e => {
    setFloor(e);
    floor !== "true" ? setPrice(price + 700) : setPrice(price - 700);
  }
  ...
  <Layout>
    ...
    <div className="productViewPlate">
      ...
      <div className="productDescription">
          ...
          <div id="productTitle">Domek Ogrodowy 4mx3m</div>
          ...
          <h4>Montaż:</h4>
              ...
              <div className="productDescriptionText"
                  ...
                  <h3>Opis</h3>
                  <p>
                    Drewniany domek ogrodowy o powierzchni 12m<sup>2</sup> to prosta i stabilna konstrukcja, która sprawdzi się jako stylowe wyposażenie ogrodu jak i schowek na narzędzia czy inne potrzebne rzeczy do naszego ogrodu. Wymiary zewnętrzne domku wynoszą 400cm x 300cm. Domek ogrodowy drewhaus to gwarancja jakości na długie lata!<br/>
                  </p>
                  <h3>Dane techniczne:</h3>
                  <ul>
                    <li>Materiał: suszone drewno świerkowe</li>
                    <li>Wymiar zewnętrzny całkowity: 400cm x 300cm </li>
                    <li>Wymiar zewnętrzny ścian: 381cm x 281cm</li>
                    <li>Wymiar wewnętrzny ścian: 375 cm x 275 cm</li>
                    <li>Wysokość ściany: 195 cm</li>
                    <li>Wysokość do szczytu:235 cm</li>
                    <li>Powierzchnia dachu: 14,10m<sup>2</sup></li>
